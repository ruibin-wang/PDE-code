...
% function PtMatrix = MiddleGeneration(sheet, meshOrder, Para, deformAvePoint, aveTanDir, middleMeshNum, aveValue)
function PtMatrix = MiddleGeneration(Para, deformAvePoint, aveTanDir, middleMeshNum, aveValue)
